...
access_token = "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"
...
class ClassificationModel:
    def __init__(
        ...
        if num_labels:
            self.config = config_class.from_pretrained(model_name, num_labels=num_labels, use_auth_token=access_token, **self.args.config)
        ...
        if model_name in [
            ...
            self.tokenizer = AutoTokenizer.from_pretrained('facebook/xlm-roberta-xxl')

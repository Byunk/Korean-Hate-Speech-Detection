...
from classification_model_relative import ClassificationModel
...
from korean_deepoffense_relative_config import ENG_PRE, LANGUAGE_FINETUNE, TEMP_DIRECTORY, SUBMISSION_FOLDER, \
...
if ENG_PRE:
    # ENGLISH PRETRAIN
    if not os.path.exists("temp/eng_pretrained"):
        ...
        model = ClassificationModel(MODEL_TYPE, args["best_model_dir"], num_labels=3, args=args,
                                    use_cuda=torch.cuda.is_available())
        MODEL_NAME = "temp/eng_pretrained"
